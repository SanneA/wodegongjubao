...
class m_menu extends Model
{
    ...
    public function getMenu()
    {
        ...
        $q = $this->db->query("SELECT mm.id,mm.mtitle,mm.mtype,mm.link,mm.server,mm.modul FROM mwc_menu mm, mwc_menu_type mmt WHERE  mm.mtype = mmt.id AND mmt.tbuild='muadmin' AND mmt.ttitle='adminmenu' order by mm.col_Seq"); //выбираем меню админа только для нашего билда
        while ($r = $q->FetchRow())
        {

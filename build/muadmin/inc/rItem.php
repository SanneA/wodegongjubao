...
class rItem
{
    ...
    {
        $filep = "build/".$_SESSION["mwccfgread"]."/_dat/items/$name.mwc";
...
{
    if(file_exists("build/".$_SESSION["mwccfgread"]."/_dat/items/sockets.php"))
    {
      if ($hex!="FFFFFFFFFF" or $hex!="0000000000")
      {
          require "build/".$_SESSION["mwccfgread"]."/_dat/items/sockets.php";
          $i=0;
          $sockets = "";
          $j =1;
          while ($i<10)
